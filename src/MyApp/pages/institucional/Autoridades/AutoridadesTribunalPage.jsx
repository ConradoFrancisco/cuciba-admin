...
export default function AutoridadesTribunalPage() {
    ...
    const { data, offset, setoffset, limit, total, setFlag, setInput, setOrderBy, setPuesto, setLimit, setOrden, setEstado } = filterObject;
            ...
            <Row>
                <Col xl={12}>
                    ...
                    <Card className="p-4 mt-4">
                        {data.length > 0 ? (<MyTableComponent deleteFunction={TribunalEticaService.delete} setActiveFunction={TribunalEticaService.setActive} data={data} filterObject={filterObject} columns={columns} AddFormComponent={<Tribunalform />} />) : (
